...
#By Ivan Felipe - RU - 3357756 - Uninter - 2023
#%%
import dash
...
df_states_ = df_states[df_states["data"] == "2020-05-13"]#inicialmente determina data
...
app.layout = dbc.Container(
    children=[
        dbc.Row([
            dbc.Col([
                    html.Div([
                        html.Img(id="logo", src=app.get_asset_url("uninter-logo.png"), height=50),
